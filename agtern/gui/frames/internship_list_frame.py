...
class InternshipListFrame(tk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        internships = [
            Internship('Google', 'Software Engineering Intern', 2023, 'Summer', 'https://careers.google.com/jobs/results/80503484702433990-software-engineering-intern-summer-2023/'),
            Internship('BNSF', 'Technology Services Intern', 2023, 'Summer', 'https://jobs.bnsf.com/job/Fort-Worth-Technology-Services-Summer-Intern-2023-%28Paid%29-%28Fort-Worth%2C-TX%29-TX-76131/931724600/'),
            Internship('FBI', 'FBI Honors Internship Program', 2023, 'Summer', 'https://www.fbi.gov/contact-us/field-offices/neworleans/news/press-releases/fbi-honors-internship-program'),
            Internship('Dell', 'Software Engineer Intern', 2023, 'Summer', 'https://jobs.dell.com/internships'),
            Internship('Apple', 'App Developer Intern', 2023, 'Summer', 'https://www.apple.com/careers/us/students.html'),
        ]
