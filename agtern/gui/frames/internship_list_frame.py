...
class InternshipListFrame(tk.Frame):
    ...
    def __init__(self, parent, *args, **kwargs):
        ...
        self._bttn_search.grid(
            row=0, column=1, sticky=tk.NS, padx=(2, 0), pady=(0, 2))
        ...
        internships = [
            Internship('Google', 'Software Engineering Intern', 2023, 'Summer',
                       'https://careers.google.com/jobs/results/80503484702433990-software-engineering-intern-summer-2023/'),
            Internship('BNSF', 'Technology Services Intern', 2023, 'Summer',
            ...
            Internship('FBI', 'FBI Honors Internship Program', 2023, 'Summer',
                       'https://www.fbi.gov/contact-us/field-offices/neworleans/news/press-releases/fbi-honors-internship-program'),
            Internship('Dell', 'Software Engineer Intern', 2023,
                       'Summer', 'https://jobs.dell.com/internships'),
            Internship('Apple', 'App Developer Intern', 2023, 'Summer',
